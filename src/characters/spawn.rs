...
#[derive(Resource)]
pub struct CharacterListRessource {
...
pub fn spawn_player(mut commands: Commands, asset_server: Res<AssetServer>, mut character_index: ResMut<CurrentCharacterIndex>,) {
    let character_list_handle: Handle<CharacterList> = asset_server.load("characters/characters.ron");

    commands.insert_resource(CharacterListRessource {
...
pub fn initialize_player_character(mut commands: Commands, asset_server: Res<AssetServer>, mut atlas_layouts: ResMut<Assets<TextureAtlasLayout>>, characters_lists: Res<Assets<CharacterList>>,
  character_index: Res<CurrentCharacterIndex>, character_list_res: Option<Res<CharacterListRessource>>, mut query: Query<Entity, (With<Player>, Without<AnimationController>)>) {
...
pub fn switch_character(input: Res<ButtonInput<KeyCode>>, mut character_index: ResMut<CurrentCharacterIndex>, characters_lists: Res<Assets<CharacterList>>, characters_list_res: Option<Res<CharacterListRessource>>,
  mut query: Query<(&mut CharacterEntry, &mut Sprite, ), With<Player>>, mut atlas_layouts: ResMut<Assets<TextureAtlasLayout>>, asset_server: Res<AssetServer>,) {
