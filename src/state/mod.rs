...
use bevy::prelude::*;
use crate::characters::spawn::CharacterListRessource;
...
fn check_assets_loaded(characters_list_res: Option<Res<CharacterListRessource>>, characters_lists: Res<Assets<CharacterList>>, mut next_state: ResMut<NextState<GameState>>,) {
